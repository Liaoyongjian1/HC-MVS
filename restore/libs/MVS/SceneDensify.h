...
public:
	...
	bool InitGraMap(DepthData& depthData); 
	bool GenerateDepthPrior(DepthData& depthData, DepthEstimator::MapRefArr& coords);
	bool GenerateFinalPrior(DepthData& depthData, DepthEstimator::MapRefArr& coords);		
	bool GenerateSuperDepthPrior(DepthData& depthData, const uint32_t label ,const int block_num);
	...
	void LSC_superpixel(DepthData& depthData);         
