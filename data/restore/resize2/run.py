...
MVS_BIN =	"~/data/restore/openmvs_build/bin"
...
pDensify = subprocess.Popen( [os.path.join(MVS_BIN, "DensifyPointCloud"), 
				  ...
				  "--n-initTriangulate","1",    #初始化标志位 1：三角初始化 0：读图初始化
				  "--n-photometric_flow","0.2", #交叉一致性权重
                                  "--n-nOptimize","0",          #帧间等滤波总标志位
                                  "--n-usepartconsistency","0", #是否做局部一致性，大于0就做
                                  "--n-usegeoconsistency","0",  #是否做几何一致性，大于0就做
